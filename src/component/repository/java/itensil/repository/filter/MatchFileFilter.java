...
public class MatchFileFilter implements NodeFilter {
	
	WildcardPattern pattern;
	
	public MatchFileFilter(String patternStr) {
		this(new WildcardPattern(patternStr));
	}
	
	public MatchFileFilter(WildcardPattern pattern) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final MatchFileFilter other = (MatchFileFilter) obj;
		if (pattern == null) {
