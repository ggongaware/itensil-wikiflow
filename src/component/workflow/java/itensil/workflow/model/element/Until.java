 ...
 *
 */
public class Until extends ContainerElement {

    public final static String NAME = "until";
    public final static String [] ATTRIBUTES = {"type", "ord", "alpha", "number", "unit", "on", "at", "field"};
    ...
    public Until(FlowModel owner, ContainerElement parent) {
        super(owner, parent);
    }
